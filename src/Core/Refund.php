...
final class Refund extends Sisp
{
    /**
     * Generate the fingerprint for a refund request.
     *
    ...
    /**
     * Generate the expected fingerprint for a refund response.
     *
     * @param array<string, mixed> $data
     */
